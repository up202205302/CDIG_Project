...
class project_802_11a(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_delay_0_0 = blocks.delay(gr.sizeof_gr_complex*1, 80)
        ...
        self.connect((self.ieee802_11_sync_short_0, 0), (self.qtgui_time_sink_x_0_0_0, 0))
